# Travel-time access to primary, secondary, and tertiary care under Saudi Arabia's health-cluster reform

Reproducibility deposit for the manuscript:

> *Travel-time access to primary, secondary, and tertiary care under Saudi Arabia's health-cluster
> reform: a national ecological study.* Submitted to BMJ Global Health.

## Contents

| File (in the Zenodo deposit) | Description |
|---|---|
...
code in the project's Zenodo deposit (<https://doi.org/10.5281/zenodo.22356711>).
...
University of Arizona. Email: abatobara@arizona.edu · ORCID:
[0009-0005-7607-1213](https://orcid.org/0009-0005-7607-1213)
